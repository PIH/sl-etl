-- this script creates a table that contains the data for the moh maternity and delivery report
-- this is aggregated in a downstream script to create the final table
...
insert into moh_maternity_and_delivery_data_staging (site, baby_obs_id, pregnancy_program_id, reporting_date, age_at_encounter, age_category, outcome, birth_weight, delivery_method, birthdate)
select 
site, 
baby_obs_id,
