...
UPDATE temp_labor_encs t
SET induced_labor = obs_value_coded_as_boolean_from_temp(encounter_id, 'PIH','15113');
UPDATE temp_labor_encs t
...
UPDATE temp_labor_encs t
SET t_first_hour = obs_value_numeric_from_temp(encounter_id, 'PIH','20114');
UPDATE temp_labor_encs t
SET t_first_minute = obs_value_numeric_from_temp(encounter_id, 'PIH','20115');
UPDATE temp_labor_encs t
SET duration_first_stage = t_first_hour+(t_first_minute/60);

UPDATE temp_labor_encs t
SET second_stage_start = obs_value_datetime_from_temp(encounter_id, 'PIH','20113');
UPDATE temp_labor_encs t
SET amtsl = obs_value_coded_as_boolean_from_temp(encounter_id, 'PIH','13533');
UPDATE temp_labor_encs t
SET visual_inspection_placenta_completeness = obs_value_coded_list_from_temp(encounter_id, 'PIH','13537','en');
UPDATE temp_labor_encs t
SET birth_attendant = obs_value_coded_list_from_temp(encounter_id, 'PIH','20118','en');
UPDATE temp_labor_encs t
SET perineal_tear = obs_value_coded_list_from_temp(encounter_id, 'PIH','12369','en');
UPDATE temp_labor_encs t
SET perineal_tear_procedure = obs_value_coded_list_from_temp(encounter_id, 'PIH','10484','en');
UPDATE temp_labor_encs t
SET multiple_birth = answerEverExists_from_temp(patient_id, 'PIH','3064','PIH','7225',null);
