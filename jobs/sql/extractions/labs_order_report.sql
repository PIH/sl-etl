...
SELECT order_type_id INTO @testOrder 
FROM order_type WHERE uuid = '52a447d3-a64a-11e3-9aeb-50e549534c5e';
SELECT  encounter_type_id INTO @specimenCollEnc 
FROM encounter_type WHERE uuid = '39C09928-0CAB-4DBA-8E48-39C631FA4286';
...
result_date
FROM temp_report
WHERE wellbody_emr_id  IS NOT NULL AND kgh_emr_id IS NOT NULL;