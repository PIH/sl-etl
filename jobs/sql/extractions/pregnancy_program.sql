...
-- TODO: If we set this like this, it will differ from any recorded LMP on a form, if they differ
...
update temp_pregnancy_program set actual_delivery_date = temp_program_encounter_latest_encounter_datetime(patient_program_id, @laborDeliverySummary);
...
update temp_pregnancy_program set delivery_location = location_name(temp_program_encounter_latest_location(patient_program_id, @laborDeliverySummary));
...
update temp_pregnancy_program set delivery_num_live_birth = temp_program_obs_num_with_value_coded(patient_program_id, @laborDeliverySummary, 'CIEL', '159917', 'CIEL', '151849');
update temp_pregnancy_program set delivery_num_fsb = temp_program_obs_num_with_value_coded(patient_program_id, @laborDeliverySummary, 'CIEL', '159917', 'CIEL', '159916');
update temp_pregnancy_program set delivery_num_msb = temp_program_obs_num_with_value_coded(patient_program_id, @laborDeliverySummary, 'CIEL', '159917', 'CIEL', '135436');
